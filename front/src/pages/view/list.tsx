                                    ...
                                    <div className={styles.lItemContainer}>
                                        {
                                            item.data && item.data.length && item.data.map((value) => (
                                                <div key={value.place_id}>
                                                    <CardColumn place_id={value.place_id} formatted_address={value.formatted_address} name={value.name} description={value.description} photo={value.photo} price_level={value.price_level ?? ""}  />
                                                </div>
                                            ))
                                        }
                                    </div>
