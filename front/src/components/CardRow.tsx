...
import styles from './style/CardRow.module.css';
...
export default function CardRow({place_id, name, description, price_level, photo, formatted_address}: ICard) {
        ...
        <div className={styles.cardWrapper}>
            <div className={styles.cardCheckbox}>
                <ChakraProvider>
                    <Checkbox
                        borderColor='#001845'
                        defaultChecked={isItemSelected(place_id)}
            ...
            <Link href={`/detail/${encodeURIComponent(place_id)}`} className={styles.cardContainer} data-testid='card-container'>
                <Image src={photo ? photo : "https://picsum.photos/seed/picsum/200/300"} alt={''} data-testid="card-image" className={styles.cardImage} width={500} height={500} />
